...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control" name="instansi" id="instansi" placeholder="Instansi"
                                value="<?php echo e(old('instansi')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            <input type="number" class="form-control" id="usia" name="usia" required
                                placeholder="usia" value="<?php echo e(old('usia')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            <select name="jenis_kelamin" id="jenis_kelamin" class="form-control"
                                value="<?php echo e(old('jenis_kelamin')); ?>" required="required">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control" id="pendidikan" name="pendidikan" required
                                placeholder="pendidikan" value="<?php echo e(old('pendidikan')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control" id="pekerjaan" name="pekerjaan" required
                                placeholder="perkerjaan" value="<?php echo e(old('perkerjaan')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            <input type="text" class="form-control" id="perihal" name="perihal" placeholder="Perihal"
                                value="<?php echo e(old('perihal')); ?>" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\1. BELAJAR\buku_tamu\resources\views/bukutamu/create.blade.php ENDPATH**/ ?>