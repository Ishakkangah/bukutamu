                    ...
                    <div class="text-white">
                        ...
                        <div class="mx-2 py-2">
                            <form action="<?php echo e(route('store')); ?>" method="post" enctype="multipart/form-data"
                                ...
                                <?php echo csrf_field(); ?>
                                <!-- Buka kamera -->
                                <input type="button" data-modal-target="defaultModal"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/bukutamu/resources/views/bukutamu/index.blade.php ENDPATH**/ ?>