...
unset($__errorArgs, $__bag); ?>
                    ...
                    <tbody>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $bukutamus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bukutamu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="text-center align-middle"> <a href="<?php echo e(route('detailsTamu', $bukutamu->id)); ?>"
    ...
    <?php else: ?>
        <?php echo $__env->make('bukutamu.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
