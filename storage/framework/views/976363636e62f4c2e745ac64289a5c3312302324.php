            ...
            <?php if(auth()->user()->role_id === 3): ?>
                <td class="align-middle">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="<?php echo e(route('detailsTamu', $d->id)); ?>" class="bg-info px-2 py-2 rounded text-white "><i
...
<?php /**PATH /var/www/html/bukutamu/resources/views/components/bodyTable.blade.php ENDPATH**/ ?>