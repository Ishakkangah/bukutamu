...
<body>
    <div class="container-fluid mx-auto my-5">
        <div class="d-flex d-flex justify-content-around align-items-center align-middle mt-5 ">
            <!-- <img alt="iamgurdeeposahan" src="<?php echo e(asset('img/logo_pemda.svg')); ?>" style="width: 100px;"> -->
            <div class="text-center col-md-8">
                <h2 class="card-title">REKAP DAFTAR PENGUNJUNG DISKOMINFO KAB. OKI</h2>
                <h3>Daftar pengunjung Tanggal <?php echo e(now()->format('d-M-Y')); ?>

                </h3>
                <p>Jl. H. M. Yusuf Singedekane No.01, Muara Baru, Kec. Kayu Agung,
                    Kabupaten Ogan Komering Ilir, Sumatera Selatan 30651</p>
            </div>
            <!-- <img alt="kominfo" src="<?php echo e(asset('img/logo_kominfo.svg')); ?>" style="width: 200px;"> -->
        </div>
        <table class="table table-bordered  mt-5">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="<?php echo e(public_path($d->takeImage)); ?>" alt="image" class="text-center shadow" style="border-radius: 5px; margin-left: 5px" width="35px">
                    </td>
...
</html><?php /**PATH /var/www/html/bukutamu/resources/views/bukutamu/cetakTamuHariIni.blade.php ENDPATH**/ ?>